...
<ul>
  <li>Bug (Indica erro no código)</li>
  <li>Documentation (Indica a necessidade de aprimoramentos ou adições à documentação)</li>
  <li>Enhancement (Indica a necessidade de adicionar novas funcionalidades ou melhorias no projeto)</li>
  <li>Infraestructure (Indica a necessidade de alterações, melhorias ou adições relacionadas à infraestrutura do projeto)</li>
  <li>Tests (Indica a necessidade de testes)</li>
</ul>

![alt text](img/etiquetas-kanban.png)
